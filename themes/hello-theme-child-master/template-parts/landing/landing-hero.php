<section class="text-gray-600 body-font">
    <div class="flex px-5 py-12 md:flex-row flex-col items-center">
        <div class="lg:flex-grow lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center md:w-[60%] xl:w-[50%]">
            ...
            <div class="flex justify-center items-center space-x-1 mt-5 group">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#444" class="w-8 h-8 animate-appear group-hover:fill-primary">
                    <path d="M383-480 200-664l56-56 240 240-240 240-56-56 183-184Zm264 0L464-664l56-56 240 240-240 240-56-56 183-184Z" />
                </svg>
                <a
                    href="<?php echo get_home_url() . '/hedge-fund-database'; ?>"
                    class="inline-flex text-black border-0 focus:outline-none cursor-pointer rounded-md text-xl uppercase animate-appear group-hover:text-primary font-medium">
                    Learn More
                </a>
            </div>
        </div>
