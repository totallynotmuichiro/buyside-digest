  ...
  <div class="w-full bg-gradient-to-b from-[#0D3E6F] to-[#080909] text-white py-12 md:py-16">
    <div class="max-w-[1410px] mx-auto flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-16 px-6 lg:px-12">
      ...
      <div class="lg:w-1/2 text-left space-y-4 md:space-y-6">
        <h1 class="text-xl md:text-3xl lg:text-4xl font-medium leading-tight text-white">Unlock the Wisdom of the Markets One Quarterly Letter at a Time</h1>
        ...
        <div class="mt-6 md:mt-8">
          <form class="flex flex-col sm:flex-row items-center sm:bg-white rounded-full p-1 free_sign_up">
            ...
            <button type="submit" class="w-full sm:w-auto mt-2 sm:mt-0 bg-[#1B365D] hover:bg-[#152a4a] text-white px-6 sm:py-3 rounded-full font-medium">Sign Up Free</button>
          </form>
        </div>
